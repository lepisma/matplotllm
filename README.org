...
development plot description usually needs a lot of iterations usually. This is
obvious as writing specifications of /anything/ brings out many hidden unshared
models between the parties involved . Data description, on the other hand,
worked well enough once specified.
